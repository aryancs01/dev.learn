            ...
            <div className="absolute top-2 right-2 z-10">
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-48">
                        <DropdownMenuItem>
                            <Link className="w-full flex gap-1 items-center" href={`/admin/courses/${data.id}/edit`}>
                                <Pencil className="size-4 mr-2"/>
                                Edit Course
                            </Link>
                        </DropdownMenuItem>
                         <DropdownMenuItem>
                            <Link className="w-full flex gap-1 items-center" href={`/courses/${data.slug}`}>
                        ...
                        <DropdownMenuItem>
                            <Link className="w-full flex gap-1 items-center" href={`/admin/courses/${data.id}/delete`}>
...
export function AdminCourseCardSkelton(){
    return (
        <Card className="group relative py-0 gap-0">
            <div className="absolute top-2 z-10 flex items-center gap-2">

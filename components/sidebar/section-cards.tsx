...
import { adminGetDashboard } from "@/app/data/admin/admin-get-dashboard-stats.course"

export async function SectionCards() {

  const {totalSignups, totalCustomers, totalCourses, totalLessons} = await adminGetDashboard()
  return (
